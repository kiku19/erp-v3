...
export const SearchWithResults: StoryObj<typeof RolesSearchModal> = {
  render: () => {
    ...
    const roles = [
      { id: "r1", name: "Site Engineer", code: "ENGR-ST", level: "Senior" as const, defaultPayType: "hourly" as const, overtimeEligible: true, skillTags: [], costRateMin: 60, costRateMax: 90, costRateCurrency: "USD" },
      { id: "r2", name: "Civil Engineer", code: "ENGR-CV", level: "Mid" as const, defaultPayType: "salaried" as const, overtimeEligible: false, skillTags: [], costRateMin: null, costRateMax: null, costRateCurrency: null },
    ];
    return (
      <RolesSearchModal
        open={true}
