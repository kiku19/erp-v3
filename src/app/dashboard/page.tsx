...
export default function DashboardPage() {
  ...
  return (
    <AuthGuard allowedRoles={["user", "admin", "superadmin"]} redirectTo="login">
      <div className="min-h-screen" style={{ background: "#0d0d0d" }}>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-white font-semibold text-sm tracking-wide">Acme Corp ERP</span>
          </div>
          <button
        ...
        <main className="px-8 py-12">
          ...
          <p className="mt-3 text-gray-400">Welcome to the ERP dashboard.</p>
        </main>
      </div>
    </AuthGuard>
  );
